            ...
            "companies": [
                {
                    ...
                    "website": "EXACT URL provided by user - do not modify or replace"
                }
            ],
            "products": [
                {
                    ...
                    "product_link": "EXACT URL provided by user - do not modify or replace"
                }
            ]
        }
        
        CRITICAL URL PRESERVATION RULES:
        - If the user provides a website URL, use that EXACT URL without any modifications
        - Do not search for or replace URLs with what you think is the "correct" website
        - Do not add http:// or https:// prefixes unless the user provided them
        - Do not modify domain names or paths in any way
        - If no URL is provided, leave the field empty or use "Not provided"
