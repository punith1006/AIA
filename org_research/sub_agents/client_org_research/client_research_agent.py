...
organizational_section_planner = LlmAgent(
    ...
    **MISSION:** Create a detailed HTML report outline that will be populated with research findings. Everything within a <div class="placeholder"> is meant to be REPLACED with actual content that is 2 TO 4 PARAGRAPHS WITHOUT THE PLACEHOLDER DIV.
    **CRITICAL** ONLY INCUDE THE SECTIONS THAT HAVE INFORMATION AVAILABLE IN THE FINDINGS. IF NO INFORMATION IS AVAILABLE TO REPLACE THE PLACEHOLDER TEXT IN THE FINDINGS, OMIT IT.
...
<body>
    <div class="container">
        ...
        <div class="executive-summary">
            ...
            <div class="content-section">
                ...
                <div class="sub-section">
                    <p><strong>Market Position & Competitive Standing:</strong></p>
                    <div class="placeholder">
                        <strong>Industry Ranking & Market Share:</strong><br>
                        • Current market position: #X player in [specific market segment] with Y% market share<br>
                        • Market ranking trends: Rising/stable/declining position over past 3 years<br>
                        • Geographic market leadership: Regions where they lead vs. lag competitors<br>
                        • Niche market dominance: Specific segments or verticals where they excel<br><br>
                        
                        <strong>Competitive Positioning Analysis:</strong><br>
                        • Market leader, challenger, follower, or niche player classification<br>
                        • Competitive differentiation: Technology, service, price, or relationship advantages<br>
                        • Brand recognition and reputation strength in target markets<br>
                        • Customer loyalty indicators: Net Promoter Score, retention rates, expansion rates<br>
                        • Competitive vulnerabilities: Areas where competitors consistently win deals<br><br>
                        
                        <strong>Market Dynamics Impact:</strong><br>
                        • How industry consolidation trends affect their position<br>
                        • Response to new market entrants and disruptive technologies<br>
                        • Adaptation to changing customer preferences and buying behaviors<br>
                        • Regulatory changes impact on competitive advantages
                    </div>

                    <p><strong>Financial Health & Stability Assessment:</strong></p>
                    <div class="placeholder">
                        <strong>Revenue Performance Indicators:</strong><br>
                        • Annual revenue: $X with Y% year-over-year growth (provide 3-year trend)<br>
                        • Revenue predictability: Recurring revenue percentage, contract length, renewal rates<br>
                        • Seasonal patterns: Quarterly variations, peak sales periods, planning implications<br>
                        • Revenue quality: Customer concentration risk, single points of failure analysis<br><br>
                        
                        <strong>Profitability & Cash Management:</strong><br>
                        • Profitability status: EBITDA margins, net income trends, path to profitability timeline<br>
                        • Cash flow generation: Operating cash flow, free cash flow, working capital efficiency<br>
                        • Cash position: Current cash reserves, burn rate, runway assessment (for growth companies)<br>
                        • Debt structure: Debt levels, covenant compliance, refinancing needs and timeline<br><br>
                        
                        <strong>Investment & Capital Structure:</strong><br>
                        • Recent funding activity: Last round size, valuation, investor profile, use of proceeds<br>
                        • Funding roadmap: Future capital needs, IPO timeline, acquisition potential<br>
                        • Capital efficiency: Revenue per employee, capital intensity, ROI on investments<br>
                        • Financial risk factors: Covenant restrictions, investor pressure, liquidity concerns
                    </div>

                    <p><strong>Growth Trajectory & Strategic Momentum:</strong></p>
                    <div class="placeholder">
                        <strong>Growth Pattern Analysis:</strong><br>
                        • Historical growth rates: 3-year CAGR for revenue, employees, market expansion<br>
                        • Growth drivers: Organic vs. inorganic growth, market expansion vs. market share gains<br>
                        • Growth sustainability: Scalability factors, resource constraints, competitive responses<br>
                        • Growth stage assessment: Startup, growth, maturity, or transformation phase<br><br>
                        
                        <strong>Expansion Strategy Execution:</strong><br>
                        • Geographic expansion: New markets entered, success rates, local partnerships<br>
                        • Product expansion: New product launches, cross-selling success, portfolio integration<br>
                        • Customer segment expansion: New verticals, company size segments, channel strategies<br>
                        • Acquisition integration: Recent acquisitions performance, cultural integration success<br><br>
                        
                        <strong>Strategic Initiative Progress:</strong><br>
                        • Digital transformation progress: Technology modernization, process automation<br>
                        • Operational excellence: Efficiency improvements, cost optimization, quality initiatives<br>
                        • Innovation investments: R&D effectiveness, patent portfolio development, technology leadership<br>
                        • Talent development: Leadership succession, skill development, culture transformation
                    </div>
                </div>
                ...
                <div class="recommendation-box">
                    <div class="placeholder">
                        <strong>Opportunity Score Framework:</strong><br>
                        • Overall Opportunity Score: [High/Medium/Low] based on weighted criteria assessment<br>
                        • Scoring Methodology: Financial capacity (25%), Strategic fit (25%), Timing (20%), Competitive position (15%), Stakeholder access (15%)<br><br>
                        
                        <strong>High-Value Indicators Present:</strong><br>
                        • Recent funding round of $X completed [date] with growth mandate from investors<br>
                        • Announced expansion plans requiring infrastructure investment of estimated $X<br>
                        • Technology modernization initiative publicly stated as strategic priority<br>
                        • New executive hires in [relevant departments] indicating investment in growth areas<br>
                        • Regulatory compliance requirements creating need for [solution category]<br>
                        • Competitive pressure requiring operational efficiency improvements<br><br>
                        
                        <strong>Deal Size Estimation Model:</strong><br>
                        • Conservative estimate: $X based on company size, industry benchmarks, typical budget allocation<br>
                        • Realistic target: $X considering their growth stage, strategic priorities, competitive pressures<br>
                        • Optimistic scenario: $X assuming full solution suite adoption and multi-year commitment<br>
                        • Expansion potential: Additional $X over 3 years through upselling and cross-selling opportunities<br><br>
                        
                        <strong>Timeline & Urgency Assessment:</strong><br>
                        • Immediate needs (0-3 months): [Specific pain points requiring immediate attention]<br>
                        • Short-term planning (3-6 months): [Budget cycle alignment, strategic initiative timeline]<br>
                        • Medium-term roadmap (6-12 months): [Implementation timeline, organizational readiness]<br>
                        • Long-term partnership (12+ months): [Strategic relationship development, expansion opportunities]
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="content-section">
            ...
            <div class="sub-section">
                <p><strong>Primary Business Model Analysis:</strong></p>
                <div class="placeholder">
                    <strong>Revenue Generation Framework:</strong><br>
                    • Core business model type (B2B, B2C, B2B2C, marketplace, platform, etc.)<br>
                    • Primary revenue mechanisms (product sales, subscriptions, licensing, transaction fees, advertising, etc.)<br>
                    • Revenue recognition patterns and billing cycles<br>
                    • Customer acquisition cost and lifetime value dynamics<br>
                    • Scalability factors and growth constraints in current model<br><br>
                    
                    <strong>Business Model Sustainability Assessment:</strong><br>
                    • Recurring vs. one-time revenue percentages<br>
                    • Customer retention and churn rate analysis<br>
                    • Market saturation risk and growth runway evaluation<br>
                    • Competitive threats to business model viability<br>
                    • Capital intensity requirements for growth<br><br>
                    
                    <strong>Strategic Business Model Insights:</strong><br>
                    • How their model creates competitive advantages<br>
                    • Integration opportunities with your solution offerings<br>
                    • Potential business model disruption risks they face<br>
                    • Areas where operational efficiency could impact profitability
                </div>

                <p><strong>Revenue Streams Deep Dive:</strong></p>
                <div class="placeholder">
                    <strong>Primary Revenue Sources (provide actual percentages where available):</strong><br>
                    • Product Line A: [X%] of total revenue - growth rate, market dynamics, profitability<br>
                    • Product Line B: [X%] of total revenue - strategic importance, competitive position<br>
                    • Services Revenue: [X%] of total revenue - margins, growth potential, customer satisfaction<br>
                    • Licensing/IP Revenue: [X%] - sustainability, renewal rates, expansion opportunities<br><br>
                    
                    <strong>Geographic Revenue Distribution:</strong><br>
                    • North America: [X%] - market maturity, growth trends, competitive landscape<br>
                    • Europe: [X%] - regulatory environment, expansion plans, local partnerships<br>
                    • Asia-Pacific: [X%] - growth potential, market entry strategies, localization needs<br>
                    • Other regions: [X%] - emerging opportunities, investment priorities<br><br>
                    
                    <strong>Customer Segment Revenue Analysis:</strong><br>
                    • Enterprise customers: [X%] - contract values, retention rates, expansion potential<br>
                    • Mid-market: [X%] - growth rates, service requirements, competitive dynamics<br>
                    • SMB segment: [X%] - acquisition costs, lifetime value, scalability challenges
                </div>

                <p><strong>Business Model Evolution & Strategic Direction:</strong></p>
                <div class="placeholder">
                    <strong>Historical Evolution Timeline:</strong><br>
                    • Founding model (Year): Original business approach and market focus<br>
                    • Major Pivot 1 (Year): What changed, why, and impact on revenue/growth<br>
                    • Major Pivot 2 (Year): Strategic shifts, new markets or products added<br>
                    • Current State: How the model has evolved and stabilized<br><br>
                    
                    <strong>Recent Strategic Changes:</strong><br>
                    • New revenue streams introduced in past 2 years<br>
                    • Discontinued products or services and rationale<br>
                    • Pricing model changes and market response<br>
                    • Channel strategy evolution and partner program changes<br><br>
                    
                    <strong>Future Model Direction Indicators:</strong><br>
                    • Announced strategic initiatives that could change revenue mix<br>
                    • Investment areas suggesting new business model components<br>
                    • Market trends they're responding to with model adjustments<br>
                    • Technology investments that could enable new revenue streams
                </div>
            </div>

            <h3>Core Products & Services Portfolio</h3>
            <div class="sub-section">
                <p><strong>Product Portfolio Analysis:</strong></p>
                <div class="placeholder">
                    <strong>Flagship Products/Services:</strong><br>
                    • Product/Service 1: Market position, competitive advantages, revenue contribution, growth trends<br>
                    • Product/Service 2: Target customers, pricing strategy, differentiation factors, market share<br>
                    • Product/Service 3: Technology foundation, scalability, customer satisfaction scores<br><br>
                    
                    <strong>Product Lifecycle Assessment:</strong><br>
                    • Growth stage products: New launches, market traction, investment levels, expansion plans<br>
                    • Mature products: Market leadership, optimization opportunities, competitive threats<br>
                    • Declining products: Sunset plans, replacement strategies, customer migration approaches<br><br>
                    
                    <strong>Product Strategy & Positioning:</strong><br>
                    • Premium vs. value positioning across product lines<br>
                    • Integration and cross-selling opportunities between products<br>
                    • White-label or OEM versions and partnership strategies<br>
                    • Customization capabilities and professional services wrap-around offerings
                </div>

                <p><strong>Innovation Pipeline & Development Strategy:</strong></p>
                <div class="placeholder">
                    <strong>Products in Development:</strong><br>
                    • Announced future products: Expected launch dates, target markets, competitive positioning<br>
                    • Beta programs: Customer feedback, market validation, feature evolution<br>
                    • Research projects: Technology exploration, patent applications, innovation partnerships<br><br>
                    
                    <strong>Innovation Investment & Priorities:</strong><br>
                    • R&D spending allocation across product lines<br>
                    • Technology modernization initiatives and legacy system upgrades<br>
                    • Customer-driven feature requests and product roadmap priorities<br>
                    • Acquisition targets for product portfolio expansion or technology acquisition<br><br>
                    
                    <strong>Innovation Partnerships & Ecosystem:</strong><br>
                    • Technology partnerships enhancing product capabilities<br>
                    • Integration partnerships expanding product ecosystem value<br>
                    • Academic collaborations and research institute relationships<br>
                    • Open source contributions and community engagement strategies
                </div>

                <p><strong>Service Delivery & Support Infrastructure:</strong></p>
                <div class="placeholder">
                    <strong>Service Capabilities Assessment:</strong><br>
                    • Professional services: Implementation, customization, training capabilities and capacity<br>
                    • Technical support: Service levels, response times, customer satisfaction metrics<br>
                    • Managed services: Outsourcing capabilities, service delivery models, geographic coverage<br>
                    • Customer success: Onboarding processes, adoption support, expansion account management<br><br>
                    
                    <strong>Delivery Model & Infrastructure:</strong><br>
                    • In-house vs. partner delivery models and capacity constraints<br>
                    • Geographic service delivery capabilities and local presence requirements<br>
                    • Technology infrastructure supporting service delivery (cloud platforms, tools)<br>
                    • Quality assurance processes and service level agreement structures<br><br>
                    
                    <strong>Support & Success Organization:</strong><br>
                    • Customer support team size, structure, and expertise levels<br>
                    • Training and certification programs for customers and partners<br>
                    • Community forums, knowledge bases, and self-service capabilities<br>
                    • Escalation processes and executive sponsor engagement models
                </div>
            </div>
        ...
        <div class="content-section">
            ...
            <div class="sub-section">
                <p><strong>Chief Executive Officer Profile:</strong></p>
                <div class="placeholder">
                    <strong>Background & Experience:</strong><br>
                    • Name: [Executive Name], Age: [X], Tenure: [X years in current role]<br>
                    • Educational background: [Universities, degrees, relevant certifications]<br>
                    • Career progression: Previous companies, roles, industries, notable achievements<br>
                    • Industry expertise: Years in industry, functional areas, specialization domains<br><br>
                    
                    <strong>Leadership Style & Decision-Making:</strong><br>
                    • Management philosophy: Data-driven, collaborative, authoritarian, consensus-building<br>
                    • Risk tolerance: Conservative, balanced, aggressive in investments and strategy<br>
                    • Communication style: Public speaking frequency, social media presence, industry engagement<br>
                    • Strategic priorities: Stated focus areas, investment themes, transformation initiatives<br><br>
                    
                    <strong>Influence on Purchasing Decisions:</strong><br>
                    • Procurement involvement: Level of direct involvement in vendor selection processes<br>
                    • Investment criteria: ROI expectations, strategic fit requirements, risk assessment approach<br>
                    • Vendor relationship preferences: Partnership vs. transactional, long-term vs. short-term focus<br>
                    • Technology adoption stance: Early adopter, fast follower, or conservative approach to new solutions
                </div>

                <p><strong>Chief Financial Officer Analysis:</strong></p>
                <div class="placeholder">
                    <strong>Financial Leadership Profile:</strong><br>
                    • Name: [Executive Name], Background: [Previous CFO roles, consulting experience, CPA status]<br>
                    • Financial philosophy: Growth vs. profitability balance, cash management approach, risk management style<br>
                    • Capital allocation priorities: Historical spending patterns, investment thesis, ROI thresholds<br><br>
                    
                    <strong>Procurement & Vendor Management Approach:</strong><br>
                    • Budget approval authority: Spending limits, approval processes, escalation requirements<br>
                    • Vendor evaluation criteria: Financial health, total cost of ownership, contract terms preferences<br>
                    • Payment terms preferences: Standard payment cycles, early payment discounts, financing arrangements<br>
                    • Risk management focus: Insurance requirements, security deposits, performance guarantees<br><br>
                    
                    <strong>Strategic Financial Initiatives:</strong><br>
                    • Cost optimization programs: Areas of focus, expected savings, timeline for implementation<br>
                    • Technology investments: ERP systems, financial reporting tools, automation initiatives<br>
                    • Compliance requirements: SOX, audit requirements, regulatory reporting needs<br>
                    • Growth funding strategy: Debt vs. equity financing, acquisition funding, working capital management
                </div>

                <p><strong>Chief Technology Officer / CIO Profile:</strong></p>
                <div class="placeholder">
                    <strong>Technology Leadership Assessment:</strong><br>
                    • Name: [Executive Name], Technical background: [Engineering, CS degree, previous CTO roles]<br>
                    • Technology philosophy: Build vs. buy preferences, open source vs. proprietary stance<br>
                    • Innovation approach: R&D investment strategy, emerging technology evaluation process<br>
                    • Team structure: Direct reports, technology organization size, skill set distribution<br><br>
                    
                    <strong>Technology Strategy & Architecture:</strong><br>
                    • Current technology stack: Cloud platforms, programming languages, databases, frameworks<br>
                    • Modernization roadmap: Legacy system replacement plans, cloud migration strategy<br>
                    • Integration architecture: API strategy, microservices adoption, data integration approaches<br>
                    • Security posture: Cybersecurity priorities, compliance requirements, risk management protocols<br><br>
                    
                    <strong>Vendor Selection & Technology Adoption:</strong><br>
                    • Technology evaluation process: Proof of concepts, pilot programs, selection criteria<br>
                    • Preferred technology partners: Existing vendor relationships, strategic partnerships<br>
                    • Implementation approach: Phased rollouts, big bang deployments, change management style<br>
                    • Success metrics: Performance benchmarks, user adoption targets, ROI measurement methods
                </div>

                <p><strong>Other Key C-Suite Executives:</strong></p>
                <div class="placeholder">
                    <strong>Chief Operating Officer:</strong><br>
                    • Name: [Executive Name], Operational focus areas, process improvement initiatives<br>
                    • Supply chain management: Vendor relationships, procurement processes, operational efficiency focus<br>
                    • Change management: Implementation capabilities, organizational transformation experience<br><br>
                    
                    <strong>Chief Marketing Officer:</strong><br>
                    • Marketing technology stack: CRM, marketing automation, analytics tools, customer data platforms<br>
                    • Digital marketing maturity: Marketing operations, data analytics, personalization capabilities<br>
                    • Brand management: Vendor co-marketing opportunities, thought leadership, event participation<br><br>
                    
                    <strong>Chief Revenue Officer / VP Sales:</strong><br>
                    • Sales technology: CRM systems, sales enablement tools, pipeline management, forecasting tools<br>
                    • Sales operations: Process optimization, territory management, compensation management systems<br>
                    • Customer relationship management: Account management systems, customer success platforms<br><br>
                    
                    <strong>Chief People Officer / HR:</strong><br>
                    • HR technology: HRIS systems, talent management, learning management, employee engagement tools<br>
                    • Workforce management: Remote work infrastructure, collaboration tools, productivity monitoring<br>
                    • Talent development: Training programs, leadership development, skills assessment platforms
                </div>
            </div>
        ...
        <div class="content-section">
            ...
            <h3>Appendix B: Reference Materials & Sources</h3>
            <div class="placeholder">
    ...
    **CRITICAL INSTRUCTIONS:**
    ...
    - Replace ALL placeholder text with the text that they require as written.
