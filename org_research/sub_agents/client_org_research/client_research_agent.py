...
organizational_plan_generator = LlmAgent(
    ...
    **INITIAL VERIFICATION STEP:**
    ...
    - If a website URL was provided by the user, use that EXACT URL for verification
    - Distinguish from similarly named organizations
    - Note any common name variations or legal entity names (e.g., "Inc.", "LLC", "Ltd.")
    - CRITICAL: Do not replace or modify any website URL provided by the user
...
organizational_section_planner = LlmAgent(
    ...
    **REPORT STRUCTURE REQUIREMENTS:**
    ...
    - Official Website: [Use EXACT URL provided by user - do not suggest alternatives]
    ...
    **CRITICAL URL PRESERVATION PROTOCOL:**
    - If a website URL was provided by the user, ALWAYS use that EXACT URL in the outline
    - Do not search for or suggest alternate website URLs
    - Do not hallucinate or invent website URLs (e.g., www.companyname.com variations)
    - Use only the URL provided by the user for all website references
    - If no URL was provided, explicitly state "Website URL not provided"
    - Do not create placeholder URLs or suggest what the URL "should be"
...
organizational_researcher = LlmAgent(
    ...
    **CRITICAL URL PRESERVATION PROTOCOL:**
    - If a website URL was provided by the user, ALWAYS use that EXACT URL
    - Do not search for or replace URLs with what you think is the "correct" website
    - Do not modify domain names, paths, or URL structure in any way
    - Preserve the exact URL format as provided by the user
    - If the provided URL appears incorrect, note this but still use the original URL
...
enhanced_organizational_search = LlmAgent(
    ...
    **CRITICAL URL PRESERVATION REQUIREMENTS:**
    - If a website URL was provided by the user, ALWAYS use that EXACT URL
    - Do not search for or replace URLs with what you think is the "correct" website
    - Do not modify domain names, paths, or URL structure in any way
    - Preserve the exact URL format as provided by the user
...
organizational_report_composer = LlmAgent(
    ...
    **5. URL PRESERVATION REQUIREMENTS:**
    - If a website URL was provided by the user, ALWAYS use that EXACT URL in the report
    - Do not search for or replace URLs with what you think is the "correct" website
    - Do not modify domain names, paths, or URL structure in any way
    - Preserve the exact URL format as provided by the user
    - If the provided URL appears incorrect, note this but still use the original URL
    - Ensure all website references use the user-provided URL exactly as given
...
organizational_intelligence_agent = LlmAgent(
    ...
    **CRITICAL URL PRESERVATION REQUIREMENTS:**
    - If a website URL was provided by the user, ALWAYS use that EXACT URL throughout the entire research process
    - Do not search for, suggest, or hallucinate alternate website URLs
    - Do not create variations like www.companyname.com if user provided a different URL
    - Use only the URL provided by the user for all website references
    - If the provided URL appears incorrect, note this but still use the original URL
    - Do not suggest what the "correct" website URL should be
