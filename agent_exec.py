...
if __name__ == "__main__":
    ...
    uvicorn.run("agent_exec:app",host="0.0.0.0", port=8052, ssl_keyfile="/opt/sales_agent/SSLCerts/key.pem", ssl_certfile="/opt/sales_agent/SSLCerts/cert.pem", log_level="info")
